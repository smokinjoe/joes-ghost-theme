...
'<img id="elRaptor" style="display: none" src="/assets/images/raptor.png" />';var raptorAudioMarkup='<audio id="elRaptorShriek" preload="auto"><source src="/assets/sounds/raptor-sound.mp3" /><source src="/assets/sounds/raptor-sound.ogg" /></audio>';var locked=false;$("body").append(raptorImageMarkup);if(audioSupported)$("body").append(raptorAudioMarkup);var raptor=$("#elRaptor").css({"position":"fixed","bottom":"-300px","right":"0","display":"none"});function init(){locked=true;$(window).scrollTop(9999999);var raptor=$("#elRaptor").css({"display":"block"});
